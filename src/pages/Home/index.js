...
const Page = () => {
  ...
  // Tri des evenements pour avoir le dernier en date en premier
  const last = data?.events.sort((evtA, evtB) =>
    new Date(evtA.date) > new Date(evtB.date) ? -1 : 1
  );

  // Ajout des id pour les liens du menu de navigation (services, réalisations, équipe, contact)
  return <>
    <header>
      <Menu />
    </header>
    ...
    <footer className="row">
      <div className="col presta">
        ...
        {/* On récupère le premier élément du tableau trié au dessus --> ligne 19 */}
        {last ? <EventCard
          ...
          small
          label="boom"
        /> : <p><span className="eventCard-loader"/> Chargement en cours...</p>}
